...
export const seedNotes: Note[] = [
  {
    id: 'scroll-demo',
    title: 'The very long scrolling demo note',
    body: [
      'This note exists purely to show how the screen scrolls when a note runs well past the height of the display. Keep scrolling and the title should slide up out of view while the body keeps flowing.',
      '',
      '1. Morning',
      'The kettle clicked off and the kitchen filled with that first warm smell of coffee. Outside, the street was still half asleep — a single jogger, a delivery van idling, the soft grey light that comes before the sun actually commits to the day.',
      '',
      '2. The list that never ends',
      'There is always a list. Buy more coffee. Call the plumber back. Reply to the email that has been sitting there, bold and unread, for three days now. Water the plants before they stage a quiet rebellion. Find out where that draft went.',
      '',
      '3. A long paragraph for good measure',
      'Lorem ipsum has its place, but real-feeling filler reads better when you are checking line height and wrapping behaviour. So here is a sprawling sentence that keeps going and going, folding over the edge of the screen, wrapping cleanly (hopefully) onto the next line, and giving the scroll view plenty of vertical real estate to work with as you drag your thumb up the glass.',
      '',
      '4. Bullet-ish thoughts',
      '- Remember to test on a small device too.',
      '- Check the bottom padding clears the floating tab bar.',
      '- Make sure the keyboard does not cover the last line.',
      '- Confirm the title stays editable up top.',
      '',
      '5. Afternoon',
      'By midday the light had gone flat and bright. The list was shorter but somehow heavier. One thing crossed off, two more added. Such is the arithmetic of a Tuesday.',
      '',
      '6. Evening',
      'Dinner was simple — pasta, garlic, too much parmesan. The dishes could wait. The day folded itself up quietly and the screen, by now, had scrolled a very long way indeed.',
      '',
      '7. Still going',
      'If you can read this, the scrolling works. There is more below, because a proper test note should outlast your patience. Almost there. Keep going.',
      '',
      '8. The end',
      'That is the bottom. Everything above scrolled smoothly, the title rose away, and the body never clipped. Test complete.',
    ].join('\n'),
    folderId: null,
